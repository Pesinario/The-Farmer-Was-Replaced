...
def new_route(): # TODO: WIP, should incorporate stockpiling of seeds BEFORE
    ...
    one_by_three   = [Unlocks.Speed, Unlocks.Expand , Unlocks.Plant,Unlocks.Expand, Unlocks.Grass]
    three_by_three = [Unlocks.Speed, Unlocks.Carrots, Unlocks.Trees,Unlocks.Speed, Unlocks.Speed, Unlocks.Expand]
